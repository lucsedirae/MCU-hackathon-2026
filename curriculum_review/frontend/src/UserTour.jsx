...
const steps = [
  ...
  { title: 'Configure OpenAI and system prompts', admin: true, text: 'Open Administration → OpenAI settings. Save your API key, select a model from the dropdown, then save and test the connection. Expand System prompt & review instructions for System prompt, Guardrails prompt, Review rubric, Evidence rules, and Examples.', tip: 'These shared instruction fields are optional. Save settings after editing them. Save and test connection saves changes before sending a small test request. Keys remain encrypted on the server.' },
