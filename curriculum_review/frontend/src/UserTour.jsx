...
const steps = [
  ...
  { title: 'Configure OpenAI and system prompts', admin: true, text: 'Open Administration → OpenAI settings. Save your API key, select a model from the dropdown, then save and test the connection. Open System prompt & instructional model to edit the single shared System prompt.', tip: 'Instructional Model currently shows ADDIE as a placeholder only; it does not affect reviews or generation. The system prompt is optional. Save settings after editing it. Save and test connection saves changes before sending a small test request. Keys remain encrypted on the server.' },
